...
<script>
  ...
  export default {
    layout: 'backend',
    name: 'BasicsInitInitgoodsGoodscost',
    components: {
      basicElxTable,
      erplrPanel,
      buttonGroup,
      ...
      return {
        ...
        tableValue: {
          ...
          tableHead: [
            ...
            { lbl: '数量', prop: 'goodsNum' },
            { lbl: '重量', prop: 'goodsWeight' },
    ...
    methods: {
      ...
      async loadData() {
        this.loading = true
        try {
          const { data } = await this.proxy(this, 'scscm/app/warehouseGoodsCostInitAjax.do', 'post', this.queryObject)
          if ('list' in data) {
