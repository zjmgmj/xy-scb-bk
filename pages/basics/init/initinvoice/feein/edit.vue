  ...
  export default {
    ...
    methods: {
      ...
      changeFee(obj) {
        ...
        // const goodsInprice = this.form.goodsInprice || 0
        // const goodsTaxrate = this.form.goodsTaxrate || 0
        // const dataBweight = this.form.dataBweight || 0
        // const goodsExprice = goodsInprice / (1 + goodsTaxrate)
        // const goodsInmoney = goodsInprice * dataBweight
        // const goodsExmoney = goodsExprice * dataBweight
        // const goodsTaxmoney = goodsInmoney - goodsExmoney
        //
        // this.formatNum(goodsExprice, '+6', 'form.goodsExprice')
        // this.formatNum(goodsInmoney, '+2', 'form.goodsInmoney')
        // this.formatNum(goodsExmoney, '+2', 'form.goodsExmoney')
        // this.formatNum(goodsTaxmoney, '+2', 'form.goodsTaxmoney')
      ...
      async asyncSave() {
        try {
          let api = 'scscm/app/invoiceFeeinInitAjax!save.do'
          if (this.form.unmakeInitId) {
            api = 'scscm/app/invoiceFeeinInitAjax!update.do'
          }
