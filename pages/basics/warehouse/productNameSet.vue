  ...
  export default {
    ...
    data () {
      return {
        ...
        editForm: [
          {lbl: '品名', prop: 'orgName'},
          {lbl: '助记码', prop: 'orgAbbreviate'},
          {lbl: '行业类别', prop: 'deptCode', type: 'select', filterable: true, labelProp: 'deptName', valProp: 'deptCode', list: []},
          {lbl: '品名大类', prop: 'deptCode', type: 'select', filterable: true, labelProp: 'deptName', valProp: 'deptCode', list: []},
          {lbl: '计件模式', prop: 'deptCode', type: 'select', filterable: true, labelProp: 'deptName', valProp: 'deptCode', list: []},
          {lbl: '计重模式', prop: 'deptCode', type: 'select', filterable: true, labelProp: 'deptName', valProp: 'deptCode', list: []},
          {lbl: '计量方式', prop: 'deptCode', type: 'select', filterable: true, labelProp: 'deptName', valProp: 'deptCode', list: []},
          {lbl: '计价方式', prop: 'deptCode', type: 'select', filterable: true, labelProp: 'deptName', valProp: 'deptCode', list: []},
          {lbl: '工作量系数', prop: 'orgBankname'},
          {lbl: '税率', prop: 'orgBankname'},
        ...
        tableValue: {          
          ...
          showRowIndex: true,
          tableHead: [
            {lbl: '品名', prop: 'orgName', width: '100px'},
            {lbl: '代码', prop: 'orgCode'},
            {lbl: '助记码', prop: 'orgAbbreviate'}, 
            {lbl: '税率', prop: 'orgCorporation'}, 
            {lbl: '品名大类', prop: 'orgPhone'},
            {lbl: '计件模式', prop: 'orgFax'},
            {lbl: '计重模式', prop: 'orgAccounts'},
            {lbl: '计量方式', prop: 'orgBankname'},
            {lbl: '工作量系数', prop: 'orgTanu', width: '120px'},
            {lbl: '理算公式', prop: 'orgAddr'},
