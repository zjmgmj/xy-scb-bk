  ...
  export default {
      ...
      return {
        ...
        tableValue: {
          ...
          tableHead: [
            ...
            {lbl: '类型', prop: 'entryinfClass', width: '120px', formatter: ({cellValue}) => {
            ...
            {lbl: '含税金额', prop: 'dataInmoney', summary: true, g_type: 'money'},
        ...
        tableBottomValue: {   
          ...
          tableHead: [
            ...
            {lbl: '款齐', prop: 'dataFundflagStr', width: '50px', align: 'center'},            
            ...
            {lbl: '退货数量', prop: 'goodsNum', summary: true, g_type: 'num'},
            {lbl: '退货重量', prop: 'goodsWeight', summary: true, g_type: 'weight'},            
    ...
    methods: {
      ...
      async showAudit () {
        ...
        try {
          const { data } = await this.proxy(this, 'scscm/app/entryinfReturnAjax!showAudit.do', 'post', this.tableSelect[0])
          if (!data.needAudit) {
      ...
      async loadData () {
        this.loading = true
        try {
          const { data } = await this.proxy(this, 'scscm/app/entryinfReturnAjax.do', 'post', this.queryObject)
      ...
      async delete (params) {
        try {          
          const { data } = await this.proxy(this, 'scscm/app/entryinfReturnAjax!delete.do', 'post', params)
          console.log(data)
          if (data.map.state === '3') {
            this.dialogShow = false
