  ...
  .mt-15
    el-tabs(type="border-card", value="1", @tab-click="handleClick")
      el-tab-pane(label="发送记录", name="1")
        send-rec(:searchFormItems="sendSearchFormItems", :tableHead="sendTableHead", :mark="mark")
      el-tab-pane(label="接收记录", name="2")
        receive-rec(:searchFormItems="recSearchFormItems", :tableHead="recTableHead", :mark="mark")
</template>
      ...
      recSearchFormItems: [
        [{label: '短信ID', model: 'id', type: 'text', placeholder: '请输入短信ID', val: ''},
         ...
         [{label: '回复人', model: 'name', type: 'text', placeholder: '请输入回复人', val: ''},
          ...
          {label: '回复时间', model: 'createAt', type: 'datetimerange', val: ''}],
         [{label: '回复内容', model: 'content', type: 'text', placeholder: '请输入回复内容', val: ''},
          {label: '回复手机', model: 'mobile', type: 'text',placeholder: '请输入回复手机', val: ''}]
      ],
      recTableHead: [{
        lbl: '短信ID',
        width: 110,
