...
export default {
  ...
  data () {
    return {
      config: {
        title: this.title,
        urlApi: 'scscm/app/shipmentAjax!queryReport.do'
      },
      likeCol: ['shipmentBillcode', 'shipmentDetailRemark'], 
      searchForm: [],  
      tableValue: {
        selection: true,
        pageination: true,
  ...
  created() {
    ...
    this.searchForm = [
      ...
      {lbl: '单据号', prop: 'shipmentBillcode', val: ''},
      {lbl: '结算单位', prop: 'datasBalcorp', typeStr: 'GYS', val: this.copyForm.datasSupplier, props: {datasBalcorpname: 'companyName'}, type:"company", disabled: datasBalcorpDisabled},
      {lbl: '供货单位', prop: 'datasSupplier', typeStr: 'GYS', val: this.copyForm.datasSupplier, props: {datasSuppliername: 'companyName'}, type:"company", disabled: datasBalcorpDisabled},
      ...
      {lbl: '备注', prop: 'shipmentDetailRemark', val: ''},
